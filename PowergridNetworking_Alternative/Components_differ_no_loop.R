...
#' @export
#'
Components_differ_no_loop <-function(g, g0, EdgeName = "name"){
  ...
  effected_nodes <-unique(c(g0_df[g0_df[,EdgeName] %in% lost_edges, 1], g0_df[g0_df[,EdgeName] %in% lost_edges, 2]))
