...
calculate_SET2 <- function(g, 
  ...
  OriginBlock_complete <- Find_network_balance3(g = List_of_BiConComps[[giant_componant]],
                                               force =force,
                                               flow = flow,
                                               distance = distance,
                                               capacity = capacity,
  ...
  height_embeddings <- Create_stabilised_blocks2(g = g,
  ...
  embeddings_data <- list(node_embeddings = height_embeddings$NodeStatus, 
